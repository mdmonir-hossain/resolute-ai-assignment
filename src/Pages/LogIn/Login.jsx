...
const Login = () => {
  ...
  return (
    <div>
      ...
      <div className=" bg-[#121212] min-h-screen grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 justify-center items-center">
        <Helmet>
          <title> Log in </title>
        </Helmet>
        <motion.div
          ...
          className="flex-1 lg:ml-3 lg:px-10 lg:py-20 border-2 border-[#fff] justify-center items-center rounded-lg "
        >
          <h1 className="text-3xl text-center text-white">Log In</h1>
          <form
